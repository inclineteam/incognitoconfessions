...
<div {{ $attributes->merge(['class' => 'group relative']) }}>
    ...
    @error($name)
        <div
            class="input-error-border group mt-2 flex w-full items-center space-x-4 rounded bg-zinc-700/50 px-4 py-2 duration-150">
    ...
    @else
        <div
            class="input-focus-styles group mt-2 flex w-full items-center space-x-4 rounded bg-zinc-700/50 px-4 py-2 duration-150">
            <i class="{{ $icon }} text-white/50 group-focus-within:text-white/80"></i>
